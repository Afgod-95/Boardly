...
export const SEED_COMMENTS: Comment[] = [
    {
        id: "c1",
        author: { id: "u1", name: "Zoe Nakamura", avatar: "https://api.dicebear.com/9.x/notionists/svg?seed=Zoe", profileUrl: "/dashboard/users/zoe" },
        ...
        replies: [
            {
                id: "c1r1",
                author: { id: "u2", name: "Felix Wagner", avatar: "https://api.dicebear.com/9.x/notionists/svg?seed=Felix", profileUrl: "/dashboard/users/felix" },
    ...
    {
        id: "c2",
        author: { id: "u3", name: "Aneka Osei", avatar: "https://api.dicebear.com/9.x/notionists/svg?seed=Aneka", profileUrl: "/dashboard/users/aneka" },
