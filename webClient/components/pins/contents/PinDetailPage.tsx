...
import { containerVariants, itemVariants } from '@/utils/animations/animations';
      ...
      <div className="md:flex md:flex-row md:gap-5">
        <div className="hidden: md:block ml-5">
          <CustomButton icon={<ChevronLeft className="text-foreground" />} onClick={() => router.back()}
            className="hidden md:block sticky text-foreground left-30 top-20 z-50 bg-muted hover:bg-accent shadow-lg transition-opacity animate-fadeIn"
          />
        </div>
