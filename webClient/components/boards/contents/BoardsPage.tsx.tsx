                ...
                {!activeFilter && (
                    <div className="space-y-4 mt-6 w-full">
                        ...
                        <div className='flex items-center justify-between'>
                            ...
                            <CustomButton 
                                onClick={() => toast.success("Organized pins!")}
                                text="Organize"
                                className='px-5 py-2 text-sm md:text-lg font-medium bg-accent rounded-full transition-colors cursor-pointer text-foreground hover:bg-muted' 
                            />
