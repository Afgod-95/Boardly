...
import CreateItemMobile from './CreateItemMobile'
      ...
      <Popover>
        <PopoverTrigger asChild onClick={() => setOpenSheet(true)}>
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className={clsx("md:px-8 flex gap-3 items-center -justify-center md:py-3 p-2.5",
              " bg-violet-700 hover:bg-violet-600 shadow-md rounded-full cursor-pointer ")}
          >
            <Plus className='block text-white' />
