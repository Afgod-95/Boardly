...
const FAQSection = () => {
  ...
  return (
    <>
      ...
      <section className="py-10 md:py-28 bg-white" id="faq">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-[1fr_1.6fr] gap-20 items-start">
            ...
            <div className="lg:sticky lg:top-24 space-y-6">
              ...
              <h2
                className="text-[clamp(2.6rem,4vw,3.8rem)] font-black text-slate-900 leading-[1.0] tracking-[-0.03em]"
              ...
              <p
                className="text-[15px] text-slate-500 leading-[1.8] max-w-[260px]"
                style={{ fontFamily: "'Cabinet Grotesk', sans-serif" }}
              >
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Plus / minus icon */}
                      <div className="shrink-0 mt-0.5 w-7 h-7 rounded-full border border-slate-200 group-hover:border-slate-400 flex items-center justify-center transition-all duration-200">
                        <motion.div
