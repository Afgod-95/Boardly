  ...
  return (
    <>
        ...
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 w-[92%] max-w-sm md:hidden">
          <div className="bg-background/90 backdrop-blur-2xl border  shadow-[0_20px_50px_rgba(0,0,0,0.1)] rounded-[2.5rem] p-2 flex items-center justify-between">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="h-12 w-12 bg-black/90 text-white rounded-full flex items-center justify-center shadow-lg shadow-violet-200/50 active:bg-violet-700"
            >
