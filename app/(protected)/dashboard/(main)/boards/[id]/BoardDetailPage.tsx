...
import { Upload, MoreHorizontal, Link as LinkIcon, Mail } from "lucide-react"
...
export default function BoardDetailPage() {
  ...
  return (
    <>
      <BackButton />
      <div className="flex flex-row items-center justify-between mb-12 mt-8 gap-6">
        <div className=" flex items-start gap-4">
          <div className="space-y-1">
            <h1 className="text-3xl font-bold sm:text-5xl tracking-tight max-w-2xl break-words">
              {board.title}
            </h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <Popover>
            <PopoverTrigger asChild>
              <button className="flex items-center justify-center gap-2 bg-gray-100 hover:bg-gray-200 p-4 px-8 rounded-full transition-all active:scale-95 font-semibold">
          ...
          <Popover>
            <PopoverTrigger asChild>
              <button className="flex items-center justify-center bg-gray-100 hover:bg-gray-200 p-4 rounded-3xl transition-all active:scale-95">
