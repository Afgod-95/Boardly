...
const SearchPageClient = () => {
    ...
    return (
        <div className="w-full min-h-screen bg-background">
            <div className="sticky top-0 z-40 bg-background/80 backdrop-blur-md border-b border-gray-100 px-4 py-4">
                <div className="max-w-6xl mx-auto flex items-center gap-4">

                    <form onSubmit={handleFormSubmit} className="relative flex-1 group">
